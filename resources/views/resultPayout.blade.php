...
<body>
    ...
    <div class="form-style-8" style="margin-top:5%;">
        <h2><img class="img-valign" style="width: 60px; height:auto" src="{{ url('/img/nicepay_logo.jpg') }}" alt="">Result Request Payout</h2>
        <form action="/approvePayout" method="post">
            @csrf
            <div class="group">
            ...
            <input type="hidden" name="tXid" value="<?= $_REQUEST['tXid'] ?>"><br>
