...
{{-- <div class="nav flex-center">
    ...
    <input class="tablinks" type="button" onclick="openCity(event, 'payMethod-form')" id="payMethod-btn" value="Virtual Account" />
</div> --}}

<!-- FORM CHECKOUT PAYMENT METHOD -->
<div id="payMethod-form" class="form-style-8">
    <div class="main-title"><img class="img-valign" style="width: 60px; height:auto" src="{{ url('/img/nicepay_logo.jpg') }}" alt="Logo">Virtual Account V2 Direct</div>
    <form action="/requestVA" method="post">
        @csrf
        ...
        <div class="group">
            <input type="number" min="1" name="vacctValidDt" value="<?=date("Ymd", strtotime(' + 3 days')) ?>" />
            <span class="highlight"></span>
            <span class="bar"></span>
        ...
        <div class="group">
            <input type="number" min="1" name="vacctValidTm" value="235959" />
            <span class="highlight"></span>
            <span class="bar"></span>
