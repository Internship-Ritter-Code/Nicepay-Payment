...
<div id="payMethod-form" class="form-style-8">
    <div class="main-title"><img class="img-valign" style="width: 60px; height:auto" src="{{ url('/img/nicepay_logo.jpg') }}" alt="Logo">QRIS V2 Direct</div>
    <form action="/requestQris" method="post">
        @csrf
        <input type="hidden" name="payMethod" value="08">
        ...
        <div class="group">
            <select name="mitraCd">
                <option selected value="QSHP">QRIS</option>
            </select>
            <span class="highlight"></span>
            <span class="bar"></span>
            <label>Mitra QRIS</label>
        </div>
        ...
        <input class="help-btn" type="button" onclick="window.location='https://docs.nicepay.co.id/api-v2-EN.html#qris'" id="home-btn" value="?" />
