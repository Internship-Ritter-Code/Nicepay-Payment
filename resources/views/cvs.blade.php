...
<div id="payMethod-form" class="form-style-8">
    <div class="main-title"><img class="img-valign" style="width: 60px; height:auto" src="{{ url('/img/nicepay_logo.jpg') }}" alt="Logo">Convenience Store V2 Direct</div>
    <form action="/requestCVS" method="post">
        ...
        <div class="group">
            <select name="mitraCd">
                <option selected value="ALMA">Alfamart</option>
                <option value="INDO">Indomaret</option>
            </select>
            <span class="highlight"></span>
            <span class="bar"></span>
            <label>Mitra CVS</label>
        </div>
        ...
        <div class="group">
            <input type="number" min="1" name="payValidDt" value="<?=date("Ymd", strtotime(' + 3 days')) ?>" />
            <span class="highlight"></span>
            <span class="bar"></span>
