...
class NicepayRequestor {
    ...
    public function operation($type) {
        ...
        if ($type == "requestVA") {
            ...
            $this->apiUrl = NICEPAY_REQ_URL;
        } else if ($type == "requestCC") {
            $this->apiUrl = NICEPAY_REQ_URL;
        } else if ($type == "requestEWallet") {
            $this->apiUrl = NICEPAY_REQ_URL;
        } else if ($type == "requestQris") {
            $this->apiUrl = NICEPAY_REQ_URL;
        } else if ($type == "requestClickPay") {
            $this->apiUrl = NICEPAY_REQ_URL;
        } else if ($type == "requestPayloan") {
            $this->apiUrl = NICEPAY_REQ_URL;
        } else if ($type == "requestPayout") {
            $this->apiUrl = NICEPAY_REQ_PAYOUT_URL;
        } else if ($type == "ApprovePayout") {
            $this->apiUrl = NICEPAY_APPROVE_PAYOUT_URL;
        } else if ($type == "RejectPayout") {
            $this->apiUrl = NICEPAY_REJECT_PAYOUT_URL;
        } else if ($type == "InquiryPayout") {
            $this->apiUrl = NICEPAY_INQUIRY_PAYOUT_URL;
        } else if ($type == "BalanceInquiry") {
            $this->apiUrl = NICEPAY_BALANCE_PAYOUT_URL;
        } else if ($type == "CancelPayout") {
            $this->apiUrl = NICEPAY_CANCEL_PAYOUT_URL;
